...
The raw file *HistoryMMRaw Mar 2024.csv* in this depository lists numerous team, singular-opponent, season-opponent, and differential statistics for every team that has played in the Round of 64 of the NCAA Men's Division I College Basketball Tournament, colloquially known as "March Madness", from 2010 to 2023. Years prior are left out due to the tournament having a different format beforehand and missing advanced data for that time period, while the most recent year is not included due to the recency of the data. (Mar 2024 is when the file was last updated; the *Sept 2023* file contains 2010-2022.)
